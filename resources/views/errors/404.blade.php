               ...
               <div class="content">
                  <div class="row">
                     <div id="site-layout-example-top" class="col s12">
                        <p class="flat-text-logo center white-text caption-uppercase">!UPS¡, lo sentimos pero no podemos encontrar esta página</p>
                     </div>
                     ...
                     <div class="row center">
                           <p class="center  col s12">Al parecer ésta pagina no existe.</p>

<aside id="left-sidebar-nav">
   <ul id="slide-out" class="side-nav fixed leftside-navigation gradient-side">
      <li class="user-details cyan darken-2">
         <div class="row" >
            <div class="col  s2 m2 l2" style="padding-left: 0.5px;">
                 <a class=""><i class="mdi-social-person white-text"></i></a> 
            </div>
      ...
      @if (Auth::guard('admin')->user()->rolCoordinador() || Auth::guard('admin')->user()->rolAdministrador())
         <li><a href="{{route('admin.asignaturas.index')}}" class=" white-text text-lighten-2 waves-effect"><i class="mdi-av-my-library-books"></i>Asignaturas</a></li>
      @endif

      @if (count(Auth::guard('admin')->user()->usuarios[0]->horarios)>0)
         <li class="no-padding mihover"><a href="{{route('matriculas.index')}}" class=" white-text text-lighten-2 waves-effect"><i class="mdi-notification-folder-special"></i>Mis Asignaturas</a></li>    
      @endif
...
<a href="#" data-activates="slide-out" class="sidebar-collapse  btn-flat medium hide-on-large-only transparent"><i class="mdi-navigation-menu white-text medium"></i></a>

    ...
    <tbody>
        @foreach ($asignaturas as $asignatura)
            <tr>
                ...
                <td>  
            	    <a href="{{route('admin.informes.pdfAsignatura',$asignatura->Id)}}" class=" modal-trigger btn-flat tooltipped " data-position="bottom" data-delay="50" data-tooltip="Informes" ><i class="material-icons red-text">picture_as_pdf</i></a>

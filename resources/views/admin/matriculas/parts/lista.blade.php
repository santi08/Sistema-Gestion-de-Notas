            ...
            <tr>
                ...
                <td class="center"> 
                    @if (count($asignatura->matriculas)>0)
                        ...
                        <a a href="{{route('notas.index', $asignatura->Id)}}" class="btn-flat  modal-trigger tooltipped " data-position="bottom" data-delay="50" data-tooltip="Gestionar Notas" ><i class="material-icons  blue-text text-darken-1">assignment</i></a>
